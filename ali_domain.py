...
class Domain:
    ...
    def create_client(self, accessKeyId, accessKeySecret):
        ...
        :return client:
        """
        config = open_api_models.Config(access_key_id=accessKeyId,
    ...
    def get_txtRecord(self, domain):
        ...
        :return:
        """
        get_txt_record_for_verify_request = alidns_20150109_models.GetTxtRecordForVerifyRequest(type='ADD_SUB_DOMAIN',
                                                                                                domain_name=domain)
    ...
    def add_domainRecord(self, domain_name, rr, type, value):
        ...
        :return result:
        """
        add_domain_record_request = alidns_20150109_models.AddDomainRecordRequest(domain_name=domain_name,
                                                                                  rr=rr,
                                                                                  type=type,
                                                                                  value=value)
    ...
    def update_domainRecord(self, recordID, rr, type, value):
        ...
        :return:
        """
        update_domain_record_request = alidns_20150109_models.UpdateDomainRecordRequest(record_id=recordID,
                                                                                        rr=rr,
                                                                                        type=type,
                                                                                        value=value)
